...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_DECORATION_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_DECORATION_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "AZURA_PROTO_UPDATE",	1);
#else
	PyModule_AddIntConstant(poModule, "AZURA_PROTO_UPDATE",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SOUL_SYSTEM",    1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SOUL_SYSTEM",    0);
#endif
...
#ifdef ENABLE_CHAT_INFO
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_INFO", 0);
#endif
