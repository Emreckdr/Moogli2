...
PyObject * textTailShowJustItemTextTail(PyObject * poSelf, PyObject * poArgs)
{
	CPythonTextTail::Instance().ShowJustItemTextTail();
	return Py_BuildNone();
}
...
void initTextTail()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "ShowJustItemTextTail",		textTailShowJustItemTextTail,		METH_VARARGS },
