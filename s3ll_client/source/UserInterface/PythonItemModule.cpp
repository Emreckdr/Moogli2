...
//Renkli A汚klama Sistemi
	...
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_HIDRA",				CItemData::APPLY_ATTBONUS_HIDRA);
	...
	PyModule_AddIntConstant(poModule, "APPLY_SWORD_REDUCTION",				CItemData::APPLY_SWORD_REDUCTION);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_TWOHAND_REDUCTION",		CItemData::APPLY_RESIST_TWOHAND_REDUCTION);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_DAGGER_REDUCTION",		CItemData::APPLY_RESIST_DAGGER_REDUCTION);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_TWOHAND_REDUCTION",		CItemData::APPLY_RESIST_TWOHAND_REDUCTION);
