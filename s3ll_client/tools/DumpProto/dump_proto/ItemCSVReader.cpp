...
#include "../../../source/UserInterface/Locale_inc.h"
#include <math.h>
...
string arITVType[] = {"ITEM_NONE", "ITEM_WEAPON",
	...
	"ITEM_PENDANT",
	"ITEM_PET",		// 35 GrowthPet
	"ITEM_MEDIUM",	// 36 Move Costume Attr
	"ITEM_GACHA",	// 37 Item Gacha
	"ITEM_SOUL",	// 38 Item Soul
...
string arIAFVSub1[] = { "WEAPON_SWORD", "WEAPON_DAGGER", "WEAPON_BOW", "WEAPON_TWO_HANDED",
				"WEAPON_BELL", "WEAPON_FAN", "WEAPON_ARROW", "WEAPON_MOUNT_SPEAR", "WEAPON_CLAW", "WEAPON_QUIVER", "WEAPON_BOUQUET", "WEAPON_UNKNOW"};
...
string arIAFVSub3[] = { "USE_POTION", "USE_TALISMAN", "USE_TUNING", "USE_MOVE", "USE_TREASURE_BOX", "USE_MONEYBAG", "USE_BAIT",
			...
			"USE_CHANGE_COSTUME_ATTR", "USE_COSTUME_TRANSFORM", "USE_COSTUME_ENCHANT", "USE_RESET_COSTUME_ATTR", "USE_SELECT_ATTRIBUTE", "USE_FLOWER", "USE_UNKNOWN_TYPE" };
...
string arIAFVSub28[] = { "COSTUME_BODY", 
						"COSTUME_HAIR", "COSTUME_MOUNT", "COSTUME_SASH", "COSTUME_WEAPON" };
...
string arIAFVSub35[] = { "PET_EGG", "PET_UPBRINGING", "PET_BAG", "PET_FEEDSTUFF", "PET_SKILL", "PET_SKILL_DEL_BOOK", "PET_SKILL_ALL_DEL_BOOK", "PET_NAME_CHANGE", "PET_EXPFOOD", "PET_EXPFOOD_PER"};
...
int arNumberOfSubtype[] =
{
	...
	0,
	0, //34
	sizeof(arIAFVSub35)/sizeof(arIAFVSub35[0]),									// 35 GrowthPet
	0,										// 36 Move Change Costume Attr
	0,										// 37 Item Gacha
	sizeof(arIAFVSub38)/sizeof(arIAFVSub38[0]),	// 38 Item Soul
#ifdef ENABLE_CHEQUE_SYSTEM
	0,										// 39
#endif
#ifdef ENABLE_ATTR_TRANSFER_SYSTEM
...
string arIAFVAntiFlag[] = {"ANTI_FEMALE", "ANTI_MALE", "ANTI_MUSA", "ANTI_ASSASSIN", "ANTI_SURA", "ANTI_MUDANG",
						...
						, "ANTI_WOLFMAN", "ANTI_CHANGELOOK", "ANTI_REINFORCE", "ANTI_ENCHANT", "ANTI_ENERGY",
						"ANTI_PETFEED", "ANTI_APPLY", "ANTI_ACCE"
						};
...
string arIATVApplyType[] = {"APPLY_NONE", "APPLY_MAX_HP", "APPLY_MAX_SP", "APPLY_CON", "APPLY_INT", "APPLY_STR", "APPLY_DEX", "APPLY_ATT_SPEED",
		...
		"APPLY_BLEEDING_PCT", "APPLY_BLEEDING_REDUCE", "APPLY_ATTBONUS_WOLFMAN", "APPLY_RESIST_WOLFMAN", "APPLY_RESIST_CLAW",
		"APPLY_ACCEDRAIN_RATE", "APPLY_RESIST_MAGIC_REDUCTION", "APPLY_ENCHANT_ELECT", "APPLY_ENCHANT_FIRE", "APPLY_ENCHANT_ICE",
		"APPLY_ENCHANT_WIND", "APPLY_ENCHANT_EARTH", "APPLY_ENCHANT_DARK", "APPLY_RESIST_HUMAN",
		"APPLY_ATTBONUS_ELECT", "APPLY_ATTBONUS_FIRE", "APPLY_ATTBONUS_ICE", "APPLY_ATTBONUS_WIND", "APPLY_ATTBONUS_EARTH", "APPLY_ATTBONUS_DARK",
		"APPLY_RESIST_SWORD_REDUCTION", "APPLY_RESIST_TWOHAND_REDUCTION", "APPLY_RESIST_DAGGER_REDUCTION",
		...
		"APPLY_ATTBONUS_INSECT", "APPLY_RESIST_CLAW_REDUCTION", "APPLY_ATTBONUS_HIDRA", "APPLY_ATTBONUS_METIN"
};
...
string arMTVType[] = { "MONSTER", "NPC", "STONE", "WARP", "DOOR", "BUILDING", "PC", "POLYMORPH_PC", "HORSE", "PET", "GOTO"};
...
int get_Mask_Type_Value(string inputString)
{
	...
	int retInt = -1;
	for (int j = 0; j<sizeof(arMaskType) / sizeof(arMaskType[0]); j++) {
...
int get_Mask_SubType_Value(int type_value, string inputString)
{
