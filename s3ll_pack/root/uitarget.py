...
class TargetBoard(ui.ThinBoard):
	...
	def OnPartyInvite(self):
		...
		questionDialog.SetText("Grup daveti yollamak istiyor musun?")
		questionDialog.SetAcceptEvent(ui.__mem_func__(self.YollaBebeq))
		questionDialog.SetCancelEvent(ui.__mem_func__(self.YollamiyomAlBudaUcu))
		questionDialog.Open()
