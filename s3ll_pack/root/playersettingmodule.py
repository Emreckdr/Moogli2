...
def __LoadGameEffect():
	...
	if app.ENABLE_ITEM_SOUL_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+45, "", "d:/ymir work/effect/etc/soul/soul_red_001.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+46, "", "d:/ymir work/effect/etc/soul/soul_blue_001.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+47, "", "d:/ymir work/effect/etc/soul/soul_mix_001.mse")
