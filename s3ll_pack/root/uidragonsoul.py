...
class DragonSoulWindow(ui.ScriptWindow):
	...
	def ActivateEquipSlotWindow(self, deck):
		self.wndEquip.ActivateSlot(player.DRAGON_SOUL_EQUIPMENT_SLOT_START + 0)
		self.wndEquip.ActivateSlot(player.DRAGON_SOUL_EQUIPMENT_SLOT_START + 1, (238.00 / 255.0), (11.00 / 255.0), (11.00 / 255.0), 1.0)
		self.wndEquip.ActivateSlot(player.DRAGON_SOUL_EQUIPMENT_SLOT_START + 2, (47.00 / 255.0), (182.00 / 255.0), (13.00 / 255.0), 1.0)
		self.wndEquip.ActivateSlot(player.DRAGON_SOUL_EQUIPMENT_SLOT_START + 3, (17.00 / 255.0), (168.00 / 255.0), (198.00 / 255.0), 1.0)
		self.wndEquip.ActivateSlot(player.DRAGON_SOUL_EQUIPMENT_SLOT_START + 4, (232.00 / 255.0), (147.00 / 255.0), (27.00 / 255.0), 1.0)
		self.wndEquip.ActivateSlot(player.DRAGON_SOUL_EQUIPMENT_SLOT_START + 5, (71.00 / 255.0), (71.00 / 255.0), (71.00 / 255.0), 1.0)
