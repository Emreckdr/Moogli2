...
MIDDLE_VALUE_FILE2 = "d:/ymir work/ui/public/Parameter_Slot_02.sub"
			...
			[
				...
				## Page Area
				{
					...
					(
						...
						## Header
						{ 
							"name":"Status_Header", "type":"window", "x":3, "y":28, "width":0, "height":0, 
							"children" :
							(
								## Lv
								{
									...
									"children" :
									(
										{ "name":"Level_Header", "type":"image", "x":-7, "y":-2, "image":"locale/tr/ui/statu_new.tga" },
										{ "name":"Level_Value", "type":"text", "x":25, "y":26, "fontsize":"LARGE", "text":"999", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									),
								},
								...
								## EXP
								{
									...
									(
										...
										{ "name":"Exp_Value", "type":"text", "x":46, "y":26, "fontsize":"LARGE", "text":"12345678901", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },									),
								},
								...
								## REXP
								{
									...
									(
										...
										{ "name":"RestExp_Value", "type":"text", "x":46, "y":26, "fontsize":"LARGE", "text":"12345678901", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									),
								},
							),
						},
						...
						## 기본 능력
						{
							...
							(
								## ?? ?? ??
								{ "name":"Character_Bar_01", "type":"horizontalbar", "x":7, "y":11, "width":222, },
								{ "name":"Character_Bar_01_Text", "type" : "image", "x" : 13, "y" : 7, "image" : "locale/tr/ui/karakter_durumu.tga", },
								...
								{ 
									...
									(
										{ "name":"Status_Plus_Value", "type":"text", "x":62, "y":0, "text":"99", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
												...
												# Basic skills item list
								{"name":"Status_Standard_ItemList1", "type" : "image", "x":14, "y":31, "image" : "locale/tr/ui/vit.tga", },
								{"name":"Status_Standard_ItemList2", "type" : "image", "x":100, "y":30, "image" : "locale/tr/ui/hp.tga", },
												# Basic skills item list
												# Basic skills item list

								## HTH
								{
									"name":"HTH_Label", "type":"window", "x":50, "y":35, "width":60, "height":20,
									"children" :
									(
										...
										{ "name":"HTH_Plus", "type" : "button", "x":43, "y":3, "default_image" : ROOT_PATH+"btn_plus_up.sub", "over_image" : ROOT_PATH+"btn_plus_over.sub", "down_image" : ROOT_PATH+"btn_plus_down.sub", },
									),
								},
								## INT
								{
									"name":"INT_Label", "type":"window", "x":50, "y":35 + (31 * 1), "width":60, "height":20,
									"children" :
									(
										...
										{ "name":"INT_Plus", "type" : "button", "x" : 43, "y" : 3, "default_image" : ROOT_PATH+"btn_plus_up.sub", "over_image" : ROOT_PATH+"btn_plus_over.sub", "down_image" : ROOT_PATH+"btn_plus_down.sub", },
									)
								},
								## STR
								{
									"name":"STR_Label", "type":"window", "x":50, "y":35 + (31 * 2), "width":60, "height":20,
									"children" :
									(
										...
										{ "name":"STR_Plus", "type" : "button", "x" : 43, "y" : 3, "default_image" : ROOT_PATH+"btn_plus_up.sub", "over_image" : ROOT_PATH+"btn_plus_over.sub", "down_image" : ROOT_PATH+"btn_plus_down.sub", },
									)
								},
								## DEX
								{
									"name":"DEX_Label", "type":"window", "x":50, "y":35 + (31 * 3), "width":60, "height":20, 
									"children" :
									(
										...
										{ "name":"DEX_Plus", "type" : "button", "x" : 43, "y" : 3, "default_image" : ROOT_PATH+"btn_plus_up.sub", "over_image" : ROOT_PATH+"btn_plus_over.sub", "down_image" : ROOT_PATH+"btn_plus_down.sub", },
									)
								},

								{ "name":"HTH_Minus", "type" : "button", "x":9, "y":38, "default_image" : ROOT_PATH+"btn_minus_up.sub", "over_image" : ROOT_PATH+"btn_minus_over.sub", "down_image" : ROOT_PATH+"btn_minus_down.sub", },
								{ "name":"INT_Minus", "type" : "button", "x":9, "y":38 + (31 * 1), "default_image" : ROOT_PATH+"btn_minus_up.sub", "over_image" : ROOT_PATH+"btn_minus_over.sub", "down_image" : ROOT_PATH+"btn_minus_down.sub", },
								{ "name":"STR_Minus", "type" : "button", "x":9, "y":38 + (31 * 2), "default_image" : ROOT_PATH+"btn_minus_up.sub", "over_image" : ROOT_PATH+"btn_minus_over.sub", "down_image" : ROOT_PATH+"btn_minus_down.sub", },
								{ "name":"DEX_Minus", "type" : "button", "x":9, "y":38 + (31 * 3), "default_image" : ROOT_PATH+"btn_minus_up.sub", "over_image" : ROOT_PATH+"btn_minus_over.sub", "down_image" : ROOT_PATH+"btn_minus_down.sub", },

								####

								## HP
								{
									"name":"HEL_Label", "type":"window", "x":145, "y":35, "width":50, "height":20,
									"children" :
									(
								...
								## SP
								{
									"name":"SP_Label", "type":"window", "x":145, "y":35 + (31 * 1), "width":50, "height":20, 
									"children" :
									(
								...
								## ATT
								{
									"name":"ATT_Label", "type":"window", "x":145, "y":35+ (31 * 2), "width":50, "height":20, 
									"children" :
									(
								...
								## DEF
								{
									"name":"DEF_Label", "type":"window", "x":145, "y":35+ (31 * 3), "width":50, "height":20, 
									"children" :
									(
						...
						## 부가 능력
						{ 
							"name":"Status_Extent", "type":"window", "x":3, "y":221 + 30, "width":200, "height":50, 
							"children" :
							(

								## ?? ?? ??
								{ "name":"Status_Extent_Label", "type" : "image", "x" : 5, "y" : 3, "image" : "locale/tr/ui/ara.tga", },

								## ?? ?? ??? ???
								{"name":"Status_Extent_ItemList1", "type" : "image", "x":14, "y":11, "image" : "locale/tr/ui/alt_left.tga", },
								{"name":"Status_Extent_ItemList2", "type" : "image", "x":100, "y":11, "image" : "locale/tr/ui/alt_right.tga", },

								## MSPD - 이동 속도
								{
									"name":"MOV_Label", "type":"window", "x":50, "y":17, "width":50, "height":20, 
									"children" :
									(
								...
								## ASPD - 공격 속도
								{
									"name":"ASPD_Label", "type":"window", "x":50, "y":17 + ( 31 * 1 ), "width":50, "height":20, 
									"children" :
									(
								...
								## CSPD - 주문 속도
								{
									"name":"CSPD_Label", "type":"window", "x":50, "y":17 + ( 31 * 2 ), "width":50, "height":20, 
									"children" :
									(
								...
								## MATT - 마법 공격력
								{
									"name":"MATT_Label", "type":"window", "x":145, "y":17, "width":50, "height":20, 
									"children" :
									(
								...
								## MDEF - 마법 방어력
								{
									"name":"MDEF_Label", "type":"window", "x":145, "y":17 + ( 31 * 1 ), "width":50, "height":20, 
									"children" :
									(
								...
								## 회피율
								{
									"name":"ER_Label", "type":"window", "x":145, "y":17 + ( 31 * 2 ), "width":50, "height":20, 
									"children" :
									(
