	...
	for (itertype(m_vec_itemTable) it = m_vec_itemTable.begin(); it != m_vec_itemTable.end(); it++)
	{
		if (g_stLocaleNameColumn != "name")
		{
			...
			snprintf(query, sizeof(query),
				...
				"masktype, masksubtype, "
#endif
				"name, %s, gold, shop_buy_price, weight, size, " //2
				...
				t.dwVnum, t.bType, t.bSubType, 
#ifdef AZURA_PROTO_UPDATE
				t.bMaskType, t.bMaskSubType, 
#endif
				t.szName, t.szLocaleName, t.dwGold, t.dwShopBuyPrice, t.bWeight, t.bSize, //11
		...
		else
		{
			...
			snprintf(query, sizeof(query),
				...
				"masktype, masksubtype, "
#endif
				"name, gold, shop_buy_price, weight, size, "
				"flag, wearflag, antiflag, immuneflag, "
				"refined_vnum, refine_set, magic_pct, socket_pct, addon_type, "
				"limittype0, limitvalue0, limittype1, limitvalue1, "
				"applytype0, applyvalue0, applytype1, applyvalue1, applytype2, applyvalue2, "
				...
				t.bMaskType, t.bMaskSubType, 
#endif
				t.szName, t.dwGold, t.dwShopBuyPrice, t.bWeight, t.bSize,
...
#endif
	name, locale_name, gold, shop_buy_price, weight, size,
...
bool CClientManager::InitializeItemTableFromDB()
{
	...
	snprintf(query, sizeof(query),
		"SELECT vnum, type, subtype, "
#ifdef AZURA_PROTO_UPDATE
		"bMaskType, bMaskSubType, "
#endif
		"name, %s, gold, shop_buy_price, weight, size,"
...
#ifdef AZURA_PROTO_UPDATE
		VERIFY_IFIELD(IProto::bMaskType,		item_table->bMaskType);
		VERIFY_IFIELD(IProto::bMaskSubType,		item_table->bMaskSubType);
#endif
