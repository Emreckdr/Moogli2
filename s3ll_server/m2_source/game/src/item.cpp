...
int CItem::FindEquipCell(LPCHARACTER ch, int iCandidateCell)
{
	...
	if ((0 == GetWearFlag() || ITEM_TOTEM == GetType()) && ITEM_COSTUME != GetType() && ITEM_DS != GetType() && ITEM_SPECIAL_DS != GetType() && ITEM_RING != GetType() && ITEM_BELT != GetType()&& ITEM_PENDANT != GetType())
		return -1;
