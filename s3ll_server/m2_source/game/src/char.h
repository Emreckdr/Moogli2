...
enum EPointTypes
{
	...
	POINT_ATTBONUS_DARK,
	POINT_RESIST_HUMAN,
	POINT_ATTBONUS_HIDRA,//171
	POINT_ATTBONUS_METIN,//172
...
#ifdef OFFLINE_SHOP
	public:
		void			OpenMyShop(const char * c_pszSign, TShopItemTable * pTable, BYTE bItemCount, DWORD days, DWORD KasmirNpc, DWORD KasmirBaslik);
		void			SendShops(bool isGm = false);
		void			OpenShop(DWORD id, const char *name, DWORD kasmirbaslik, DWORD kasmirnpc, bool onboot = false);
